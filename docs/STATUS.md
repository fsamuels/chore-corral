...
7. Then verify M4's done-state against the hosted project: create and soft-delete a category on each farm and confirm both events land in `activity_log` (the active-task guard is already unit-tested; exercise it for real once M5 tasks exist)

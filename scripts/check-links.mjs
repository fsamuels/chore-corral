 ...
 *
 * The docs cross-reference each other heavily (README's documentation map links every
 * file under docs/), so a renamed heading breaks links silently. This catches that.
 *
